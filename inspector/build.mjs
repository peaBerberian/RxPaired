...
if (
  process.env.npm_config_inspector_debugger_url === undefined ||
  process.env.npm_config_device_script_url === undefined
) {
...
function buildWebInspector(options) {
  ...
  esbuild.build({
    ...
    define: {
      _INSPECTOR_DEBUGGER_URL_: JSON.stringify(process.env.npm_config_inspector_debugger_url),
